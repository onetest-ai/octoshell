...
- [`tfidf-margin-gate-blind-to-exact-top-ties.md`](tfidf-margin-gate-blind-to-exact-top-ties.md) — a runner-up margin gate written as "find a candidate with a DIFFERENT score" can't see two-or-more candidates tied exactly for the top spot; one wins arbitrarily instead of the match being rejected as ambiguous.

...
const handlers: { [M in RpcMethod]: RpcHandler<M> } = {
  ...
  "campaign:update": (a, c) => { c.board.updateBrief("campaign", a.campaignId, { description: a.description, acceptanceCriteria: a.acceptanceCriteria, target: a.target }); return { ok: true }; },
  ...
  "mission:update": (a, c) => { c.board.updateBrief("mission", a.missionId, { description: a.description, acceptanceCriteria: a.acceptanceCriteria }); return { ok: true }; },
  ...
  "task:update": (a, c) => { c.board.updateBrief("task", a.taskId, { description: a.description, acceptanceCriteria: a.acceptanceCriteria }); return { ok: true }; },
  ...
  "bug:update": (a, c) => { c.board.updateBrief("bug", a.bugId, { name: a.title, severity: a.severity, description: a.description, stepsToReproduce: a.stepsToReproduce, expected: a.expected, actual: a.actual, rca: a.rca, environment: a.environment }); return { ok: true }; },

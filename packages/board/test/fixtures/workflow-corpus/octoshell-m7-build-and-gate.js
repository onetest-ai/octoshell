export const meta = {
  ...
  phases: [
    { title: "Build", steps: [
      {"id":"t1","agent":"js-dev","label":"Compute boundary-crossing working sets"},
      {"id":"t2","agent":"js-dev","label":"Thin-history rule, one spelling","dependsOn":["t1"]},
      {"id":"t3","agent":"js-dev","label":"Render the Working sets section","dependsOn":["t2"]},
      {"id":"t4","agent":"qa-engineer","label":"End-to-end hazard suite","dependsOn":["t3"]},
    ] },
    { title: "Review", steps: [
      {"id":"rv","agent":"tech-lead","label":"Review task diff, remediate in place","dependsOn":["t4"]},
    ] },
    { title: "Verify", steps: [

export const meta = {
  ...
  phases: [
    { title: "Build", steps: [
      {"id":"t1","agent":"js-dev","label":"IO port and the setup flow"},
      {"id":"t2","agent":"js-dev","label":"Missing uv and the safety rules","dependsOn":["t1"]},
      {"id":"t4","agent":"qa-engineer","label":"End-to-end hazard suite","dependsOn":["t2"]},
    ] },
    { title: "Review", steps: [

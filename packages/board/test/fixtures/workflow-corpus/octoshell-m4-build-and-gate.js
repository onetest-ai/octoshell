export const meta = {
  ...
  phases: [
    { title: "Build", steps: [
      {"id":"t1","agent":"js-dev","label":"Board and worklog readers"},
      {"id":"t2","agent":"js-dev","label":"Merge-SHA capture and attribution","dependsOn":["t1"]},
      {"id":"t3","agent":"js-dev","label":"Lexical predictor, measured threshold","dependsOn":["t2"]},
      {"id":"t4","agent":"js-dev","label":"The own command","dependsOn":["t3"]},
      {"id":"t5","agent":"js-dev","label":"The conflicts command","dependsOn":["t4"]},
      {"id":"t6","agent":"qa-engineer","label":"End-to-end hazard suite","dependsOn":["t5"]},
    ] },
    { title: "Review", steps: [
